package br.sc.senac.budgetech.error;
...
import br.sc.senac.budgetech.exception.client.ClientCpfInvalidException;
import br.sc.senac.budgetech.exception.client.ClientCpfRegisteredException;
import br.sc.senac.budgetech.exception.client.ClientLoginRegisteredException;
import br.sc.senac.budgetech.exception.client.ClientNotFoundException;
import br.sc.senac.budgetech.exception.color.ColorNotFoundException;
import br.sc.senac.budgetech.exception.contact.ContactEmailInvalidException;
import br.sc.senac.budgetech.exception.contact.ContactEmailRegisteredException;
import br.sc.senac.budgetech.exception.contact.ContactNotFoundException;
import br.sc.senac.budgetech.exception.contact.ContactPhoneNumberRegisteredException;
import br.sc.senac.budgetech.exception.furniture.FurnitureInvalidException;
import br.sc.senac.budgetech.exception.furniture.FurnitureNameRegisteredException;
import br.sc.senac.budgetech.exception.furniture.FurnitureNotFoundException;
import br.sc.senac.budgetech.exception.item.ItemInvalidException;
import br.sc.senac.budgetech.exception.item.ItemNotFoundException;
...
import br.sc.senac.budgetech.exception.woodwork.WoodworkCnpjInvalidException;
import br.sc.senac.budgetech.exception.woodwork.WoodworkCnpjRegisteredException;
import br.sc.senac.budgetech.exception.woodwork.WoodworkLoginRegisteredException;
...
public class CustomControllerAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleItemInvalidException(Exception exception) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse(HttpStatus.BAD_REQUEST, exception.getMessage()));
    }
