package br.sc.senac.budgetech.backend.controller.livingArea;
...
public class LivingAreaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<LivingAreaProjectionC16andW16> getProjectionById(@PathVariable(value = "id") Long id) {
