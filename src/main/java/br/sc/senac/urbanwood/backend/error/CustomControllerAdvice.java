package br.sc.senac.urbanwood.backend.error;

import br.sc.senac.urbanwood.backend.exception.address.AddressInvalidException;
import br.sc.senac.urbanwood.backend.exception.address.AddressNotFoundException;
import br.sc.senac.urbanwood.backend.exception.address.AddressStreetAndNumberRegisteredException;
import br.sc.senac.urbanwood.backend.exception.client.ClientCpfInvalidException;
import br.sc.senac.urbanwood.backend.exception.client.ClientCpfRegisteredException;
import br.sc.senac.urbanwood.backend.exception.client.ClientLoginRegisteredException;
...
import br.sc.senac.urbanwood.backend.exception.contact.ContactEmailRegisteredException;
import br.sc.senac.urbanwood.backend.exception.contact.ContactNotFoundException;
import br.sc.senac.urbanwood.backend.exception.contact.ContactPhoneNumberRegisteredException;
...
import br.sc.senac.urbanwood.backend.exception.woodwork.WoodworkCnpjRegisteredException;
import br.sc.senac.urbanwood.backend.exception.woodwork.WoodworkLoginRegisteredException;
